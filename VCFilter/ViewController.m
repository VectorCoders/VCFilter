...
//  VCFilter
//
//  Created by 张世仁 on 2020/4/19.
//  Copyright © 2020 张世仁. All rights reserved.
//
...
- (void)viewDidLoad
{
    ...
    // 获取所有视频滤镜分类
    NSArray *filterCategory = [CIFilter filterNamesInCategory:kCICategoryVideo];
    // CIPhotoEffectFade:黑白

    // NSLog(@"%@ %@",filter,filter.inputKeys);

    // NSLog(@"%@",filterCategory);
}
...
//    NSLog(@"%@",[NSThread currentThread]);
    ...
    // 滤镜处理 (CoreImage)           CINoiseReduction
